<template>
  <view class="page">
    ...
    <view class="login-hero">
      ...
      <text class="login-hero-sub">教职工端 · 教师/财务与迎新职工</text>
    </view>
...
export default {
  ...
  data() {
    return {
      ...
      demoAccounts: [
        ...
        { role: '财务人员', account: '2001', password: '123456', phone: '13800138001' },
        { role: '学工处负责人', account: '2101', password: '123456', phone: '13800138011' },
        { role: '学院负责人', account: '2201', password: '123456', phone: '13800138021' },
        { role: '迎新工作人员', account: '2301', password: '123456', phone: '13800138031' }
      ]
    }
  },
  onLoad(options) {
  ...
  methods: {
    ...
    async onPwdLogin() {
      ...
      uni.showToast({ title: '账号未绑定教师或财务职工角色', icon: 'none' })
    },
    ...
    resolveLocalLogin(account) {
      ...
      const users = {
        ...
        2001: { role: 'finance', type: 3, staffPosition: 'cashier', name: '陈美玲', userId: 'staff_finance_001', phone: '13800138001' },
        finance: { role: 'finance', type: 3, staffPosition: 'cashier', name: '陈美玲', userId: 'staff_finance_001', phone: '13800138001' },
        f2026001: { role: 'finance', type: 3, staffPosition: 'cashier', name: '陈美玲', userId: 'staff_finance_001', phone: '13800138001' },
        '13800138001': { role: 'finance', type: 3, staffPosition: 'cashier', name: '陈美玲', userId: 'staff_finance_001', phone: '13800138001' },
        2101: { role: 'finance', type: 3, staffPosition: 'student_affairs', name: '周老师', userId: 'staff_affairs_001', phone: '13800138011' },
        '13800138011': { role: 'finance', type: 3, staffPosition: 'student_affairs', name: '周老师', userId: 'staff_affairs_001', phone: '13800138011' },
        2201: { role: 'finance', type: 3, staffPosition: 'college_leader', name: '李主任', userId: 'staff_college_001', phone: '13800138021', college: '计算机学院' },
        '13800138021': { role: 'finance', type: 3, staffPosition: 'college_leader', name: '李主任', userId: 'staff_college_001', phone: '13800138021', college: '计算机学院' },
        2301: { role: 'finance', type: 3, staffPosition: 'orientation', name: '王老师', userId: 'staff_orientation_001', phone: '13800138031' },
        '13800138031': { role: 'finance', type: 3, staffPosition: 'orientation', name: '王老师', userId: 'staff_orientation_001', phone: '13800138031' }
      }
      ...
      return {
        ...
        phone: matched.phone,
        staffPosition: matched.staffPosition,
    ...
    saveUserInfo(userInfo) {
      ...
      const query = {
        ...
        staffPosition: userInfo.staffPosition,
