...
export default {
  ...
  async onShow(){ this.filterVersion++; await this.refresh() }, methods:{
    ...
    async refresh(){ try{ var r=await scholarshipApi.getScholarshipList({pageNum:1,pageSize:200,tab:"processing",role:"government"}); if(r&&r.code===0) this.list=(r.data.items||[]).map(function(i){return Object.assign({},i,{uid:i.scholarshipId})}) }catch(e){} },
}}
</script>
