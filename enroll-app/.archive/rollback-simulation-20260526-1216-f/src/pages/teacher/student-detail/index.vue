...
.btn-p { width: 100%; height: var(--btn-h); background: var(--brand); color: var(--white); border-radius: var(--btn-radius); font-size: var(--fs-14); font-weight: 600; display: flex; align-items: center; justify-content: center; transition: background .3s, transform .2s; }
.btn-p:active { background: var(--brand-d); transform: scale(0.97); }
.btn-e-outline { width: 100%; height: var(--btn-h); border-radius: var(--btn-radius); border: 1.5px solid var(--brand); color: var(--brand); font-size: var(--fs-14); font-weight: 600; display: flex; align-items: center; justify-content: center; background: var(--white); }
