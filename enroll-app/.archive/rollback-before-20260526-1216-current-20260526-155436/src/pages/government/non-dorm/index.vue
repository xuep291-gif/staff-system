<template>
  <view class="page">
    ...
    <scroll-view scroll-y class="body">
      <view class="sc">
        <view class="card" v-for="(item, i) in list" :key="item.uid" @click="goReview(item)">
          <view class="card-bd">
            <view class="li">
...
const DEFAULT_LIST = [
  { uid: 'gnd-1', name: '赵刚', id: '2026010008', address: '校园路12号', status: '待终审', badgeColor: 'wa', avatar: '赵' },
  { uid: 'gnd-2', name: '孙丽', id: '2026010019', address: '学府花园3栋', status: '班主任已通过', badgeColor: 'ok', avatar: '孙' },
  { uid: 'gnd-3', name: '王磊', id: '2026010015', address: '阳光小区5号楼', status: '待终审', badgeColor: 'wa', avatar: '王' }
]
