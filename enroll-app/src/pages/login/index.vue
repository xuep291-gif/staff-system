  ...
  methods: {
    ...
    resolveLocalLogin(account) {
      ...
      const users = {
        ...
        2001: { role: 'finance', type: 3, name: '陈美玲', userId: 'staff_finance_001', phone: '13800138001', subRole: 'fee_collector', permissions: ['finance:overview','finance:collect','finance:records','finance:refund','finance:diff','finance:receipt','finance:urge','finance:payout','finance:aid-review','finance:loan-review','finance:stats'], dataScope: { type: 'all' } },
        finance: { role: 'finance', type: 3, name: '陈美玲', userId: 'staff_finance_001', phone: '13800138001', subRole: 'fee_collector', permissions: ['finance:overview','finance:collect','finance:records','finance:refund','finance:diff','finance:receipt','finance:urge','finance:payout','finance:aid-review','finance:loan-review','finance:stats'], dataScope: { type: 'all' } },
        f2026001: { role: 'finance', type: 3, name: '陈美玲', userId: 'staff_finance_001', phone: '13800138001', subRole: 'fee_collector', permissions: ['finance:overview','finance:collect','finance:records','finance:refund','finance:diff','finance:receipt','finance:urge','finance:payout','finance:aid-review','finance:loan-review','finance:stats'], dataScope: { type: 'all' } },
