...
export default {
  ...
  data() {
    return { uid: '', item: null, opinion: '资格复核通过，同意进入教师终审。', rejectReason: '', showPreview: false, showReject: false, submitting: false, aidTypes: ['国家助学金', '学校助学金', '社会助学金', '临时困难补助'], editAmount: '' }
  },
  computed: {
    aidTypeIndex() {
